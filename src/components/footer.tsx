...
const Footer = () => {
  ...
  //         <div className="flex-1 ml-10 text-left my-10">
  ...
  //   />
  //   <button className="h-8 ml-2 px-3 bg-yellow-600 rounded-sm cursor-pointer">
  ...
  //           <div className="flex justify-between mr-10 my-10">
  //             <div className="">
